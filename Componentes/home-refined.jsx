...
const PANELS = [
  { type: "title" },
  { type: "image", label: "hero-1 · década 2010", from: "#7a4f1f", to: "#3a1f0c" },
  { type: "image", label: "hero-2 · lustro 2015", from: "#3a4a6e", to: "#0d1a2e" },
  { type: "image", label: "hero-3 · año 2020",     from: "#3a5a4a", to: "#0d1f15" },
  { type: "image", label: "hero-4 · año 2023",     from: "#7a6024", to: "#2a1f0a" },
];
        ...
        <div key={i} className={`tcube-panel${i === active ? " is-active" : ""}`}>
          {panel.type === "title" ? (
            ...
            >
              ...
              <div className="tcube-image__caption">{panel.label}</div>
              <span className="tcube-image__hint">Ver historia →</span>
            </div>
          )}
        </div>
      ))}
...
function Hero({ accent, bgVariant }) {
  return (
    <section className={`hero hero--${bgVariant}`} id="inicio">
