    ...
    <main className="pdet-main">
        ...
        <div className="container">
          <div className="pdet-top__inner">
            ...
            <aside className="pdet-specs">
              ...
              {/* WhatsApp CTA */}
              <a
                href={`https://wa.me/593984909878?text=${encodeURIComponent(`Hola, me interesa el producto: ${producto.nombre} (${producto.serie}). ¿Pueden darme más información?`)}`}
                target="_blank"
      ...
      <div className="pdet-nav">
        <div className="container">
          ...
          <Link href="/unete" className="btn btn--sky">
